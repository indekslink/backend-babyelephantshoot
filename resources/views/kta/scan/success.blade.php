...
@section('title','Active KTA')

@section('content')
<div class="relative-content text-center pb-4">
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <img src="/assets/images/success1.png" alt="" class="img-fluid ">

        </div>
    </div>

    <div class="display-3 font-logo fw-bold text-center mb-2">KTA is <span class="text-success font-logo">Active</span>
    </div>
